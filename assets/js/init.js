jQuery(document).ready(function () {
  ...
  miwie_tm_modalbox();
  miwie_tm_counter();
  miwie_tm_trigger_menu();
  miwie_tm_service_popup();
  miwie_tm_modalbox_news();
  miwie_tm_modalbox_portfolio();
  progress_by_frenify();
  miwie_tm_cursor();
  miwie_tm_imgtosvg();
  miwie_tm_popup();
  miwie_tm_data_images();
  miwie_tm_contact_form();
  miwie_tm_owl_carousel();
  miwie_tm_down();
  miwie_tm_nav_bg();
  hashtag();
  filter_hashtag();
...
function miwie_tm_modalbox() {
  "use strict";
  jQuery(".miwie_tm_all_wrap").prepend(
    '<div class="miwie_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
function miwie_tm_trigger_menu() {
  "use strict";
  var hamburger = jQuery(".trigger .hamburger");
  var mobileMenu = jQuery(".miwie_tm_mobile_menu .dropdown");
  var mobileMenuList = jQuery(
    ".miwie_tm_mobile_menu .dropdown .dropdown_inner ul li a"
  );
...
function miwie_tm_service_popup() {
  "use strict";
  var modalBox = jQuery(".miwie_tm_modalbox");
  var button = jQuery(".miwie_tm_service .miwie_tm_full_link");
  var list = jQuery(".miwie_tm_service .service_list ul li");
...
function miwie_tm_modalbox_news() {
  "use strict";
  var modalBox = jQuery(".miwie_tm_modalbox");
  var button = jQuery(
    ".miwie_tm_news .miwie_tm_full_link,.miwie_tm_news .title a,.miwie_tm_news .miwie_tm_simple_button a"
  );
  var closePopup = modalBox.find(".close");
  button.on("click", function () {
    var element = jQuery(this);
...
function miwie_tm_modalbox_portfolio() {
  "use strict";
  var modalBox = jQuery(".miwie_tm_modalbox");
  var button = jQuery(".miwie_tm_portfolio .details_link");
  var closePopup = modalBox.find(".close");
  ...
  if (myCursor.length) {
    if ($("body")) {
      ...
      (window.onmousemove = function (s) {
        ...
        $("body").on(
          "mouseenter",
          "a, .miwie_tm_testimonials .avatars ul li, .cursor-pointer",
          function () {
...
function miwie_tm_contact_form() {
  "use strict";
...
function miwie_tm_owl_carousel() {
  "use strict";
  var carousel = jQuery(".miwie_tm_portfolio .owl-carousel");
  var rtlMode = false;
  ...
  var carousel2 = jQuery(".miwie_tm_partners .owl-carousel");
...
function miwie_tm_down() {
  "use strict";
  var header = jQuery(".miwie_tm_header").height();
...
function miwie_tm_portfolio_masonry() {
  "use strict";
  $(".grid").masonry({ itemSelector: ".grid-item" });
}
function miwie_tm_nav_bg() {
  "use strict";
  jQuery(window).on("scroll", function () {
    var menu = jQuery(".miwie_tm_header");
...
function hashtag() {
  "use strict";
  var ccc = $(".miwie_tm_header .menu .ccc");
  var element = $(".miwie_tm_header .menu .current a");
  $(".miwie_tm_header .menu a").on("mouseenter", function () {
    var e = $(this);
    currentLink(ccc, e);
  });
  $(".miwie_tm_header .menu").on("mouseleave", function () {
    element = $(".miwie_tm_header .menu .current a");
...
function currentLink(ccc, e) {
  ...
  var menuleft = $(".miwie_tm_header .menu").offset().left;
  ccc.css({ left: left - menuleft + "px", width: width + "px" });
}
function filter_hashtag() {
  "use strict";
  var ccc = $(".miwie_tm_informations .right .filter .ccc");
  var element = $(".miwie_tm_informations .right .filter .current");
  $(".miwie_tm_informations .right .filter a").on("mouseenter", function () {
    var e = $(this);
    currentLinkFilter(ccc, e);
  });
  $(".miwie_tm_informations .right .filter").on("mouseleave", function () {
    element = $(".miwie_tm_informations .right .filter .current");
...
function currentLinkFilter(ccc, e) {
  ...
  var menuleft = $(".miwie_tm_informations .right .filter").offset().left;
  ccc.css({ left: left - menuleft - 40 + "px", width: width + "px" });
}
function service_hashtag() {
  "use strict";
  var ccc = $(".miwie_tm_service .ccc");
  var element = $(".miwie_tm_service .current");
  $(".miwie_tm_service .service_list ul li").on("mouseenter", function () {
    var e = $(this);
    currentLinkService(ccc, e);
  });
  $(".miwie_tm_service .service_list").on("mouseleave", function () {
    element = $(".miwie_tm_service .current");
...
function currentLinkService(ccc, e) {
  ...
  var menuTop = $(".miwie_tm_service .service_list").offset().top;
...
function miwie_tm_about_tabs() {
  "use strict";
  var button = jQuery(".miwie_tm_informations .right .filter ul li a");
  var tabList = jQuery(".miwie_tm_informations .right .content .wrapper");
  button.on("click", function () {
    var element = jQuery(this);
